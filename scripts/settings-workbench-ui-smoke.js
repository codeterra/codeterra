...
assertContains(html, 'data-settings-tab="stash"', 'stash top nav tab');
assertContains(html, 'data-settings-panel="stash"', 'stash settings panel');
assertContains(html, 'id="refresh-stash-index-button"', 'refresh stash index button');
assertContains(html, 'id="price-stash-index-button"', 'price stash index button');
assertContains(html, 'id="stash-results-list"', 'stash results list');
assertContains(html, 'id="shopping-list-input"', 'shopping list input');
assertContains(html, 'id="compare-shopping-list-button"', 'compare shopping list button');
...
assertContains(html, 'id="ggg-session-token-input"', 'GGG session token input');
assertContains(html, 'id="ggg-session-account-name-input"', 'GGG session account name input');
assertContains(html, 'id="save-session-account-name-button"', 'save session account name button');
assertContains(html, 'id="save-session-token-button"', 'save session token button');
assertContains(html, 'id="validate-session-token-button"', 'validate session token button');
assertContains(html, 'id="disconnect-session-token-button"', 'disconnect session token button');
...
assertContains(html, 'id="populate-divination-card-tiers-button"', 'populate div card tiers button');
assertContains(html, 'id="populate-unique-tiers-button"', 'populate unique tiers button');
assertContains(html, 'data-grouped-target="flasks"', 'flasks misc-items subtab');
assertContains(html, 'data-grouped-panel="flasks"', 'flasks misc-items pane');
...
assertContains(renderer, "document.querySelector('#ggg-session-token-input')");
assertContains(renderer, "document.querySelector('#ggg-session-account-name-input')");
assertContains(renderer, 'setGggSessionAccountName');
assertContains(renderer, "document.querySelector('#stash-results-list')");
assertContains(renderer, "document.querySelector('#populate-divination-card-tiers-button')");
assertContains(renderer, "document.querySelector('#populate-unique-tiers-button')");
assertContains(renderer, "document.querySelector('#shopping-list-input')");
assertContains(renderer, 'function renderGggSessionStatus');
assertContains(renderer, 'function renderStashState');
assertContains(renderer, 'function renderShoppingListResults');
...
assertContains(renderer, 'function createHexInput');
assertContains(renderer, 'function normalizeHexColor');
assertContains(renderer, 'function normalizeStyleOpacity');
assertContains(renderer, 'function getStyleOpacity');
assertContains(renderer, 'function appendStyleOpacityControl');
assertContains(renderer, 'function syncColorControlInput');
assertContains(renderer, 'function createStyleClipboardActions');
assertContains(renderer, 'function copyStyleFromButton');
assertContains(renderer, 'function pasteStyleFromButton');
assertContains(renderer, 'function applyStyleToSurface');
assertContains(renderer, 'data-copy-style');
assertContains(renderer, 'data-paste-style');
...
assertContains(renderer, 'function createBaseNamePickerField');
assertContains(renderer, 'function createClassNamePickerField');
assertContains(renderer, 'function openBaseNamePicker');
assertContains(renderer, 'function openClassNamePicker');
assertContains(renderer, 'function buildBaseNamePickerOptions');
assertContains(renderer, 'function buildClassNamePickerOptions');
assertContains(renderer, 'function renderDivinationCardTierList');
assertContains(renderer, 'function collectDivinationCardTierRules');
assertContains(renderer, 'populateDivinationCardTiers');
assertContains(renderer, 'populateUniqueTiers');
assertContains(renderer, 'UNIQUE_TIER_DEFAULTS');
assertContains(renderer, 'TIERED_CATEGORY_CONFIGS');
assertContains(renderer, 'DIVINATION_CARD_TIER_DEFAULTS');
assertContains(renderer, 'data-div-card-tier-row');
assertContains(renderer, 'data-div-card-tier-add');
assertContains(renderer, 'data-div-card-tier-search');
assertContains(renderer, 'BASE_NAME_PICKER_POLICIES');
assertContains(renderer, "fragments: { contextual: true, equipment: false, profile: false, catalog: false, current: true }");
assertContains(renderer, 'data-open-base-name-picker');
assertContains(renderer, 'data-open-class-name-picker');
assertContains(renderer, 'Select Items');
assertContains(renderer, 'Select Classes');
...
assertContains(css, '.swatch-input input[type="text"]');
assertContains(css, '.swatch-input input.is-invalid');
assertContains(css, '.style-opacity-input');
assertContains(css, '.style-clipboard-actions');
...
assertContains(css, '.base-name-picker-drawer');
assertContains(css, '.base-name-picker-grid');
assertContains(css, '.base-name-field');
assertContains(css, '.div-card-tier-row');
assertContains(css, '.div-card-chip');
assertContains(css, '.div-card-chip.is-search-match');
assertContains(css, '.stash-report-grid');
